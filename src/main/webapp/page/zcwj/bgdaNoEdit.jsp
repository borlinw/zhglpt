...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	$(function(){
			    ...
			    columns:[[
			        {field:'c',title:'操作',width:150,align:'center',formatter:function(value,row,index){
			        	//if(row.fbdw==$.cookie("unit"))
			        		return '<a style="text-decoration:none;color:#3399CC;" href="#" onclick="ckwj('+index+')">查看</a>    '+
		...
		function ztjl(index){
			...
			obj=data;
			YMLib.UI.createWindow('bgda_ztjl','状态记录',"/zhglpt/page/zcwj/bgda_ztjlNoEdit.jsp",'bgda_ztjl',1000,400);
		}
		//添加
		function xxtztj(){
			var weatherDlg = new J.dialog( {
				id : 'id2',
				title : '工程档案添加',
				page : 'bgda_add.jsp?url='+"/zhglpt/wjxt/uploadWjFile.do"+'&flag=bgdaNoEdit.jsp'+'&id='+new Date().getTime(),
				width : 570,
				height : 530,
				top : 0,
				rang : true,
		...
		function ckwj(index){
			...
			var weatherDlg = new J.dialog( {
				id : 'id2',
				title : '工程档案编辑',
				page : 'bgda_ck.jsp?url='+"/zhglpt/wjxt/uploadWjFile.do"+'&flag=bgdaNoEdit.jsp'+'&id='+data.id,
				width : 570,
				height : 530,
				top : 0,
				rang : true,
