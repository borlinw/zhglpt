...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	$(function(){
		...
		function ztjl(index){
			...
			obj=data;
			YMLib.UI.createWindow('gcda_ztjl','状态记录',"/zhglpt/page/zcwj/gcda_ztjlNoEdit.jsp",'gcda_ztjl',1000,400);
		}
		//添加
		function xxtztj(){
		...
		function ckwj(index){
			...
			var weatherDlg = new J.dialog( {
				id : 'id2',
				title : '工程档案编辑',
				page : 'gcda_ck.jsp?url='+"/zhglpt/wjxt/uploadWjFile.do"+'&flag=gcdaNoEdit.jsp'+'&id='+data.id,
				width : 570,
				height : 530,
				top : 0,
				rang : true,
