...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function showAll(){
			...
			$('#datagrid').datagrid({    
			    url:'/zhglpt/wjxt/selectzcwjlist.do',
			    striped:true,
			    pagination:true,
			    rownumbers:true,
			    pageNumber:1,
		...
		function xxtztj(){
			var weatherDlg = new J.dialog( {
				id : 'id2',
				title : '制度文件添加',
				page : 'zcwj_add.jsp?url='+"/zhglpt/wjxt/uploadWjFile.do"+'&flag=zcwj.jsp'+'&id='+new Date().getTime(),
				width : 570,
				height : 400,
				top : 0,
				rang : true,
		...
		function editwj(index){
			...
			var weatherDlg = new J.dialog( {
				id : 'id2',
				title : '制度文件编辑',
				page : 'zcwj_xg.jsp?url='+"/zhglpt/wjxt/uploadWjFile.do"+'&flag=zcwj.jsp'+'&id='+data.id,
				width : 570,
				height : 400,
				top : 0,
				rang : true,
		...
		function deletewj(index){
			...
			$.ajax({
				type:'post',
				url:'/zhglpt/wjxt/deleteZcwj.do',
				data:"wjgl.id="+data.id+"&wjgl.wjid="+data.id,
				dataType:'json',
				async:false,
